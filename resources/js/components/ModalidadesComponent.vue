            ...
            <table class="table table-striped table-bordered border-danger bg-white">
                ...
                <tbody class="text-center">
                    <tr v-for="modalidad in modalidades" :key="modalidad.id">
                        ...
                        <td>
                            <button type="button" @click="update=true; eliminar(modalidad.id);" class="btn btn-outline-danger btn-sm">
            ...
            async save()
            {
                ...
                else
                {
                    try
                    {
                        ...
                        //.then(response=>{console.log(response.data)})
                        const res = await axios.post('/dashboard/modalidades_api', fields).then(response=>{console.log(response.data)});
                    }
                    catch(error)
                    {
                        if(error.response.data)
