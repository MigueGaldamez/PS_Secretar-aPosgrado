            ...
            <div class="col-sm-4 text-center">
                <nav>
                    <ul class="pagination">
                        ...
                        <li class="page-item" :class="{disabled:pagination.page==tesis.last_page}" >
                            <a class="page-link" @click="pagination.page++, list();" href="#">
                        ...
                        <li class="page-item" :class="{disabled:pagination.page==tesis.last_page}" >
                            <a class="page-link" @click="pagination.page=tesis.last_page, list();" href="#" >
    ...
    export default 
    {
        ...
        methods:
        {
            async list()
            {
                ...
                {
                    this.cargando = true;
                    const res = await axios.get('/dashboard/tesis_api',{params:this.pagination,});
                    this.tesis = res.data;
                    this.listarPaginas();
                    this.cargando = false;
                }
            ...
            async listarSelects()
            {
                const resP = await axios.get('/dashboard/posgrados_list');
