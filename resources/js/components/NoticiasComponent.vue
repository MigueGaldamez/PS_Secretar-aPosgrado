    ...
    <div class="row">
                ...
                <div class="modal-content">
                    ...
                    <form v-on:submit.prevent="guardar" enctype="multipart/form-data">
                        ...
                        <div class="modal-footer">
                            ...
                            <button v-on:click="cerrarModal();" type="button" class="btn btn-secondary" >Cerrar</button>
                        </div>
                    </form>
                </div>
            </div> 
        ...
        <div class="row mt-1 mb-1">
            <div class="col-sm-1">
                ...
                <select @change="listar(); filtros.page=1;" v-model="filtros.per_page" class="form-select form-select-sm" aria-label=".form-select-sm example">
        ...
        <form @submit.prevent="listar">
            <div class="row mt-1 mb-1">
                ...
                <div class="col-sm-1 align-self-end">
                    <button @click="filtros.page=1; listar();"  type="submit" class="btn btn-outline-dark">
