                ...
                <div class="modal-content">
                    ...
                    <form v-on:submit.prevent="save">
                        ...
                        <div class="modal-footer">
                            <button @click="save();" type="button" data-bs-dismiss="modal" class="btn btn-success">Guardar</button>
        ...
        <form @submit.prevent="list">
            <div class="row mt-1 mb-1">
                ...
                <div class="col-sm-3">
                    ...
                    <select v-model="filtros.modalidad" class="form-select" aria-label="facultad">
                        <option value=0 >Selecciona una Modalidad</option>
                        <option v-for="modalidad in modalidades" :key="modalidad.id" v-bind:value="modalidad.id"> {{modalidad.nombre}}</option>
                    </select>
                </div>
            ...
            <div class="table-responsive">
                <table class="table table-striped table-bordered border-primary ">
                    ...
                    <tbody class="text-center">
                        <tr v-for="diplomado in diplomados.data" :key="diplomado.id">
                            ...
                            <td>
                                <button type="button" @click="update=true; openModal(diplomado);" data-bs-toggle="modal" data-bs-target="#exampleModal" class="btn btn-outline-info btn-sm">
            ...
            <div class="col-sm-4 text-center">
                <nav>
                    <ul class="pagination">
                        ...
                        <li class="page-item" :class="{disabled:filtros.page==diplomados.last_page}" >
                            <a class="page-link" @click="filtros.page++, list();" href="#">
                        ...
                        <li class="page-item" :class="{disabled:filtros.page==diplomados.last_page}" >
                            <a class="page-link" @click="filtros.page=diplomados.last_page, list();" href="#" >
    ...
    export default 
    {
        ...
        methods:
        {
            async list()
            {
                ...
                {
                    this.cargando = true;
                    const res = await axios.get('/dashboard/diplomados_api/',{params:this.filtros});
