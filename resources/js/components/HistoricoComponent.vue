        ...
        <div class="row mt-1 mb-1">
            <div class="col-sm-4">
                <div class="border rounded">
                    <label for="customRange3" class="form-label"> {{reseniaHistoricas.from}} - {{reseniaHistoricas.to }} total: {{reseniaHistoricas.total}}</label>
                        <input type="range" data-bs-toggle="popover" data-bs-placement="top" data-bs-content="Top popover" class="form-range" min="1" v-model="pagination.per_page" v-bind:max="reseniaHistoricas.total" step="4" @change="listar();" id="customRange3">
                    ...
                    <tbody>
                        <tr v-for="rese in reseniaHistoricas.data" :key="rese.id">
                            ...
                            <td>
                                ...
                                <button type="button" @click="update=true; eliminarM(rese.id);" class="btn btn-outline-danger btn-sm">
