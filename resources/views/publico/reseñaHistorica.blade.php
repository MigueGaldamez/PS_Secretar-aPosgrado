...
<div class="colorGris mt-2">
    ...
    {{--inicio carousel--}}
        <div id="carouselExampleCaptions" class="carousel slide carrouselHistoria" data-bs-ride="carousel" >
            ...
            <div class="carousel-inner">
                <div class="carousel-item active carrouselHistoria">
                ...
                <div class="carousel-item carrouselHistoria">
...
Actualmente, la UES ha logrado ampliar la oferta académica: 79 carreras en modalidad presencial y 7 a distancia; 80 maestrías, 8 doctorados, 27 especialidades médicas y 65 diplomados como parte de la educación continua.
